package com.eumji.eutil.secure.rsa;
...
public class RSAUtil {
     ...
     * 生成密钥对
     */
    private static Map<String, String> initKey() throws NoSuchAlgorithmException {
    ...
    public static String decryptByPubKey(String data, String publicKey) throws Exception {
        byte[] design = decryptByPubKey(decodeBase64(data), decodeBase64(publicKey));
    ...
    public static String decryptByPriKey(String data, String privateKey) throws Exception {
        byte[] design = decryptByPriKey(decodeBase64(data), decodeBase64(privateKey));
        return new String(design);
    }
